...
class _ConductorpageState extends State<Conductorpage> {
  ...
  createAccountPressed() async {
    http.Response response = await AuthServices.conductorRegister(
        _name, _fechanacimiento, _ci, _telefono, _categorialic);
    ...
    if (response.statusCode == 401) {
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (BuildContext context) => const MicrobusPage(),
          ));
    } else {
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  TextField(
                    decoration:
                        const InputDecoration(hintText: 'fecha Nacimiento'),
                    onChanged: (value) {
                  ...
                  TextField(
                    decoration:
                        const InputDecoration(hintText: 'carnet identidad'),
                    onChanged: (value) {
                      _ci = value;
                    },
                  ),
                  ...
                  TextField(
                    decoration:
                        const InputDecoration(hintText: 'categoria licencia'),
                    onChanged: (value) {
                      _categorialic = value;
                    },
                  ),
